...
const detailsSlice = createSlice({
  ...
  initialState: {
    detailsInfo: {
      ...
      reviews: [
        {
          comments:
            "民宿位置很好，出去转个弯就是北京路商业街，很方便。房间的投影是有会员的，可以看很多影片！ps.一定要记得关好门窗！不然晚上有蚊子骚扰😭",
          created_at: "2022-05-27T00:00:00Z",
          is_translated: false,
          localized_date: "2022年5月",
          reviewer_image_url:
            "https://a0.muscache.com/im/pictures/user/1f61f128-ac6a-4b4c-b936-1ea12a7d8491.jpg?aki_policy=x_medium",
  ...
  reducers: {
    changeDetailsInfoAction(state, { payload }) {
      state.detailsInfo = payload;
    },
  },
});
export const { changeDetailsInfoAction } = detailsSlice.actions;
